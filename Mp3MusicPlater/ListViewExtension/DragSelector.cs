...
namespace Mp3MusicPlater
{
    ...
    /// </summary>
    public sealed class DragSelector : BaseViewModel
    {
        #region Properties
        ...
        async Task<Size> BoundSize(Size Size, Point Point, Size ItemsControlSize)
        {
            ...
            {
                double Width =
                    Size.Width + Point.X > ItemsControlSize.Width
                        ? ItemsControlSize.Width - Point.X
                        : Size.Width;
                double Height =
                    Size.Height + Point.Y > ItemsControlSize.Height
                        ? ItemsControlSize.Height - Point.Y
                        : Size.Height;
        ...
        /// </summary>
        bool IsModifierPressed() => (Keyboard.Modifiers & ModifierKeys.Control) != 0 || (Keyboard.Modifiers & ModifierKeys.Shift) != 0;
        ...
        /// </summary>
        void OnScrollViewerLoaded(object sender, RoutedEventArgs e) => FindScrollContent();
